...
2. Collect/derive values for placeholders:
   ...
   - **DEFAULT PRINCIPLES**: If user input is empty or does not specify principles, use the following defaults:
     ...
     2. **Test-Driven Development** — Models, logic, services, APIs: TDD mandatory (tests FIRST → verify FAIL → implement → refactor). Mobile/UI where unit tests don't fit: spec-first (acceptance criteria before implementation, verify with snapshot/UI/E2E after). Models and ViewModels always use full TDD. Minimum 80% coverage for testable code.
